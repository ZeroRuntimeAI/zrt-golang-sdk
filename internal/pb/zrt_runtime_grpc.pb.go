...
type AgentRuntimeClient interface {
	...
	// api-server-facing: terminates a dispatched session. Triggers the runtime
	// to shut down the orchestrator + transport, which causes the per-session
	// forwarder to push SessionEnded back down the SDK's bidi stream.
	Terminate(ctx context.Context, in *TerminateRequest, opts ...grpc.CallOption) (*TerminateResponse, error)
	// Test-only: synthesize a `ToolCallRequest` and push it directly down the
	// SDK's bidi stream. Bypasses the orchestrator/LLM so you can verify the
	// runtime ↔ SDK tool-call wire path without involving STT/Gemini.
	TestEmitToolCall(ctx context.Context, in *TestEmitToolCallRequest, opts ...grpc.CallOption) (*TestEmitToolCallResponse, error)
}
...
func (c *agentRuntimeClient) RegisterAgent(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AgentStreamIn, AgentStreamOut], error) {
	...
	x := &grpc.GenericClientStream[AgentStreamIn, AgentStreamOut]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentRuntime_RegisterAgentClient = grpc.BidiStreamingClient[AgentStreamIn, AgentStreamOut]
...
func (c *agentRuntimeClient) TestEmitToolCall(ctx context.Context, in *TestEmitToolCallRequest, opts ...grpc.CallOption) (*TestEmitToolCallResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TestEmitToolCallResponse)
	err := c.cc.Invoke(ctx, AgentRuntime_TestEmitToolCall_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentRuntimeServer interface {
	...
	// SDK's bidi stream. Bypasses the orchestrator/LLM so you can verify the
	// runtime ↔ SDK tool-call wire path without involving STT/Gemini.
	TestEmitToolCall(context.Context, *TestEmitToolCallRequest) (*TestEmitToolCallResponse, error)
...
func (UnimplementedAgentRuntimeServer) TestEmitToolCall(context.Context, *TestEmitToolCallRequest) (*TestEmitToolCallResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TestEmitToolCall not implemented")
}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentRuntime_RegisterAgentServer = grpc.BidiStreamingServer[AgentStreamIn, AgentStreamOut]
...
func _AgentRuntime_TestEmitToolCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestEmitToolCallRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentRuntimeServer).TestEmitToolCall(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentRuntime_TestEmitToolCall_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentRuntimeServer).TestEmitToolCall(ctx, req.(*TestEmitToolCallRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentRuntime_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TestEmitToolCall",
			Handler:    _AgentRuntime_TestEmitToolCall_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _AgentRuntime_RegisterAgent_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
